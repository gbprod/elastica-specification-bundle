 ...
 * All changes must be documented in the [CHANGELOG.md](https://github.com/gbprod/elastica-specification-bundle/blob/master/CHANGELOG.md) in respect of [Keep a Changelog](http://keepachangelog.com/) Standard.
